...
All 10 plugins use the OpenCode v1.14.48+ (currently pinned at v1.15.4) client API for user-visible and structured logging instead of `console.log` (which lands only in the server log file `~/.local/share/opencode/log/*.log` and is invisible to the user):
