...
uvx --from "pytest==9.1.1" --with "pyyaml==6.0.3" --with "jsonschema==4.26.0" --with "referencing==0.37.0" pytest scripts/tests/  # 500 passed + 1 skipped across 23 suites
...
uvx --from "ruff==0.15.20" ruff check scripts                            # python lint
```
