...
1. Detect project type, branch/worktree, submodules, CI surface,/agent-only policy.
...
4. When the root control plane is present, use `scripts/ry_repair_sync.py --plan/--check` before claiming local repo, system AI CLI config, Serena, GitHub, or tracked context sync.
