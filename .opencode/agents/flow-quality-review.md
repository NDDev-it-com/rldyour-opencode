---
description: "Ревью качества реализации, completeness, edge cases, error handling и resource lifecycle. EN: orchestrated read-only quality review. Explicit ry-start or ry-review only."
mode: subagent
temperature: 0.1
steps: 36
hidden: true
